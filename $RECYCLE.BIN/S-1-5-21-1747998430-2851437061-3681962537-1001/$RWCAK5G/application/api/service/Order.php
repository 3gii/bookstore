...
class Order
{
     ...
     * @throws Exception
     */
    public function place($message,$uid, $oProducts)
    {
        ...
        $orderSnap['leavingMessage']=$message;
...
//            ->update(['status' => OrderStatusEnum::DELIVERED]);
    ...
    private function getProductsByOrder($oProducts)
    {
        ...
        $products = Product::all($oPIDs)
            ->visible(['id', 'price', 'stock', 'name', 'main_img_url','supplier'])
            ->toArray();
        return $products;
    }
    ...
    private function createOrderByTrans($snap)
    {
        try {
            ...
            $order->leaving_message = $snap['leavingMessage'];
    ...
    private function snapProduct($product, $oCount)
    {
        ...
        $pStatus['id'] = $product['id'];
        $pStatus['supplier'] = $product['supplier'];
