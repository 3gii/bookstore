...
Page({
        ...
        * */
                ...
                order.getOrderInfoById(id, (data)=> {
                    that.setData({
                        ...
                        basicInfo: {
                            ...
                            leavingMessage: data.leaving_message
                        },
                    });
        ...
        _firstTimePay:function(){
            ...
            order.doOrder(that.data.value,orderInfo,(data)=>{
                //订单生成成功
                if(data.pass) {
                    //更新订单状态
        ...
        */
        _execPay:function(id){
          ...
          wx.showModal({
            title: '提示',
            content: '请保证个人信息真实有效，确认支付',
            success: function (res) {
              if (res.confirm) {
                if(!order.onPay) {
                that.showTips('支付提示','支付系统未开通，仅支持货到付款',true);//屏蔽支付，提示
        ...
        */
        ...
        getStatus:function(data){
                if(data>0){
                    this.showTips('提示','删除成功',true);
                }
                else{
                    this.showTips('提示','删除失败',false);
                }
