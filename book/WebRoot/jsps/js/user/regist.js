$(function() {
	...
	$("#submitBtn").hover(
		function() {
			$("#submitBtn").attr("src", "/testshop/images/regist2.jpg");
		},
		function() {
			$("#submitBtn").attr("src", "/testshop/images/regist1.jpg");
		}
	);
...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url:"/testshop/UserServlet",//要请求的servlet
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#imgVerifyCode").attr("src", "/testshop/VerifyCodeServlet?a=" + new Date().getTime());
}
