package cn.xmy.goods.admin.web.servlet;
...
import cn.xmy.goods.order.domain.Order;
import cn.xmy.goods.order.service.OrderService;
import cn.xmy.goods.pager.PageBean;
import cn.xmy.goods.user.domain.User;
import cn.itcast.servlet.BaseServlet;
/*
 * author：zhangguopeng
 * 加个版本标识吧 免得警告(^_^)
 * 订单处理   这个页面展示类似book（包括分页）
 * edittime: 2017.11.17
 */
...
public class AdminOrderServlet extends BaseServlet {
	 ...
	 * 版本标识
	 */
	private static final long serialVersionUID = 5672391789424146735L;
	 ...
	 */
	/*
	 * http://localhost:8080/testshop/BookServlet?methed=findByCategory&cid=xxx&pc=3
	 * /testshop/BookServlet + methed=findByCategory&cid=xxx&pc=3
	 */
