package cn.xmy.goods.user.web.servlet;
...
import cn.xmy.goods.user.service.UserService;
import cn.xmy.goods.user.service.UserException;
...
public class UserServlet extends BaseServlet {
	...
	public String login(HttpServletRequest req, HttpServletResponse resp)
		...
		if(errors.size() > 0) {
			req.setAttribute("msg", errors.get("msg"));
